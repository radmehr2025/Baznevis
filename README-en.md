...
- **Compound Word Database:** Uses a built-in dictionary to handle complex compound words (e.g., 'نرم‌افزار', 'گفت‌وگو').
- **Interactive Editing:** Unique feature! Click on any corrected word in the output to toggle between a half-space and a regular space.
- **Punctuation Cleanup:** Corrects the positioning of commas, semicolons, and question marks.
- **Digit Conversion:** Automatically converts English digits to Persian digits.
